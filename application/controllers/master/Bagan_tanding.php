...
class Bagan_tanding extends CI_Controller {
    ...
    $this->load->view('master/bagan_tanding');
  ...
  public function cetak()
  {
    ...
    $this->load->view('master/cetak/bagan_tanding', $data);
  }
    ...
    $data_pengundian_tanding = $this->db->query("SELECT
		...
		var_dump($data_pengundian_tanding); die();
		...
		$data['teams'] = count($data_pengundian_tanding);
