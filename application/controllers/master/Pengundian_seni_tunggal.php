...
class Pengundian_seni_tunggal extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('master/M_pengundian_seni_tunggal', 'model');
    ...
    $this->load->view('master/pengundian_seni_tunggal', $data);
