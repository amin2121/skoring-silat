...
class Jadwal_seni_tunggal extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('pertandingan/M_jadwal_seni_tunggal', 'model');
    ...
    $this->load->view('pertandingan/jadwal_seni_tunggal', $data);
