      ...
      <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <div class="panel-elements pull-right">
              <a href="<?php echo base_url(); ?>setting/user/view_tambah"><button class="btn btn-sm btn-primary"><i class=""></i>Tambah</button></a>
            </div>
        </div>
...
<script>
    ...
    function get_data() {
        ...
        $.ajax({
            url: '<?= base_url('setting/user/get_data') ?>',
            method: 'GET',
            data: {search},
            dataType: 'json',
    ...
    function edit_data(id) {
      window.location.href = '<?php echo base_url(); ?>setting/user/view_edit/'+id
    }
