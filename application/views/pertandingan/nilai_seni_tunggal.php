...
<title>Halaman Penilaian Seni Tunggal</title>
...
<div class="juri">
    ...
    <div class="container">
        <div class="" style="display: flex; justify-content: flex-start; margin-bottom: 12px;">
...
<script>
  ...
  let pusher_verifikasi_juri = new Pusher('e636cb98a16cc38f57fe', {
      cluster: 'ap1'
  })

  let channel_verifikasi_juri = pusher_verifikasi_juri.subscribe('verifikasi-juri')
  channel_verifikasi_juri.bind('action-verifikasi-juri', function(data) {
    let id_jadwal_pertandingan = $(`#input-jadwal-pertandingan`).val()

    if(id_jadwal_pertandingan == data.id_jadwal_pertandingan) {
  ...
  // PUSHER END VERIFIKASI JURI

  // PUSHER REFRESH NILAI
  let pusher_refresh_nilai = new Pusher('e636cb98a16cc38f57fe', {
      cluster: 'ap1'
  })

  let channel_refresh_nilai = pusher_refresh_nilai.subscribe('refresh-monitor')
  channel_refresh_nilai.bind('action-refresh-monitor', function(data) {
