...
<style>
  .content {
    /* background-color: #ADBC9F; 151515*/
    background-color: #151515;
  }

  .menit, .detik, .asal-pesilat, .live-waktu {
    color: #ffffff;
  }
  ...
  <div id="popup_load">
      ...
      <div class="dewan">
        ...
        <div class="content">
            <div class="data-pesilat">
                ...
                <div class="waktu-pertandingan col-sm-6" style="text-align:center;">
                  <p class="live-waktu">
                      <span class="menit">00</span>:<span class="detik">00</span>
                  </p>
                </div>
                <div class="informasi-pesilat-merah col-sm-3" style="text-align:right;">
    ...
    <script>
        ...
        socket.onmessage = function(event) {
            ...
            } else if(data.status_awalwaktuu == '1'){
              handleWebsocketMessageAwalWaktu(data);
            } else if(data.status_jurii == '1'){
              handleWebsocketMessageJuri(data);
            } else if(data.status_monitorr == '1'){
              handleWebsocketMessageMonitor(data);
        ...
        // WEBSOCKET GANTI AWAL WAKTU
        function handleWebsocketMessageAwalWaktu(data){
          let id_jadwal_pertandingan = document.getElementById('input-jadwal-pertandingan').value;
          if(data.id_jadwal_pertandingan == id_jadwal_pertandingan) {
        ...
        // WEBSOCKET END GANTI AWAL WAKTU
        
        // WEBSOCKET GANTI ROUND
        function handleWebsocketMessageRound(data){
          let id_jadwal_pertandingan = document.getElementById('input-jadwal-pertandingan').value;
          if(data.id_jadwal_pertandingan == id_jadwal_pertandingan) {
              get_ronde()
              remainingSeconds = data.reset_waktuu * 60 * 100;
              updateInterfaceTime()
        ...
        // WEBSOCKET ACTIVE JURI
        function handleWebsocketMessageJuri(data){
          let id_jadwal_pertandingan = document.getElementById('input-jadwal-pertandingan').value;
          if(data.id_jadwal_pertandingan == id_jadwal_pertandingan) {
            console.log(data.juri)
            if(data.nilai == 1) {
        ...
        // WEBSOCKET END ACTIVE JURI

        // WEBSOCKET REFRESH MONITOR
        function handleWebsocketMessageMonitor(data){
          let id_jadwal_pertandingan = document.getElementById('input-jadwal-pertandingan').value;
          if(data.id_jadwal_pertandingan == id_jadwal_pertandingan) {
