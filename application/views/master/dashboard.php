           ...
           <div class="form-group row">
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input type="hidden" name="id_ip" id="id_ip" value="<?php echo $ip['id']; ?>">
                    <input type="text" class="form-control" name="ip" id="ip" value="<?php echo $ip['ip']; ?>">
                </div>
                <button class="btn btn-success btn-sm mr-2" onclick="ubah_ip()" type="submit">Ubah IP</button>
            </div>
           </div>
          <br>
          <div class="form-group row">
...
<script>
    ...
    function ubah_ip() {
        ...
        $.ajax({
            url: '<?= base_url('master/dashboard/ubah_ip') ?>',
            method: 'POST',
            data: {id:id, ip:ip},
            dataType: 'json',
            success: function (res) {
                console.log(res.ip);
                window.location.href = `http://${res.ip}/skoring_silat/master/dashboard`;
            }
        })
    }
