      ...
      <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <div class="panel-elements pull-right">
              <a href="<?php echo base_url(); ?>master/peserta_seni_tunggal/view_tambah"><button class="btn btn-sm btn-primary"><i class=""></i>Tambah</button></a>
  ...
  <div class="modal fade" id="modal-import-data" tabindex="-1" role="dialog" aria-labelledby="modal-warning-header">
    <div class="modal-dialog modal-info" role="document">
        ...
        <div class="modal-content">
            ...
            <form class="" action="<?php echo base_url('master/peserta_seni_tunggal/import_excel') ?>" id="form-import-excel" method="post" enctype="multipart/form-data">
...
<script>
    ...
    function get_data() {
        ...
        $.ajax({
            url: '<?= base_url('master/peserta_seni_tunggal/get_data') ?>',
            method: 'GET',
    ...
    function edit_data(id) {
      window.location.href = '<?php echo base_url(); ?>master/peserta_seni_tunggal/view_edit/'+id
    }
    ...
    function hapus(){
      ...
      $.ajax({
        url: '<?php echo base_url('master/peserta_seni_tunggal/hapus') ?>',
        method: 'GET',
        data: {id},
        dataType: 'json',
        success: function (res) {
    ...
    function detail_data(id){
      ...
      $.ajax({
          url: '<?= base_url('master/peserta_seni_tunggal/detail_data') ?>',
          method: 'GET',
          data: {id},
          dataType: 'json',
