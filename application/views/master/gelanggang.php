    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Data Gelanggang</h3>
            <div class="panel-elements pull-right">
              <a href="<?php echo base_url(); ?>master/gelanggang/view_tambah"><button class="btn btn-sm btn-primary"><i class=""></i>Tambah</button></a>
            </div>
        </div>
...
<script>
    ...
    function get_data() {
        ...
        $.ajax({
            url: '<?= base_url('master/gelanggang/get_data') ?>',
            method: 'GET',
            data: {search},
            dataType: 'json',
                  ...
                  for(const item of res) {
                    tr += `
                      <tr>
                          ...
                          <td class="text-center">${item.gelanggang}</td>
                          <td class="text-center">
                            <div class="btn-group">
                              <button class="btn btn-warning btn-sm" type="button" onclick="playAudio('<?php echo base_url('storage/gong/') ?>${item.gong}')" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-play"></i></button>
                            </div>
                          </td>
                          <td class="text-center">
                              <div class="btn-group">
    ...
    function edit_data(id) {
      window.location.href = '<?php echo base_url(); ?>master/gelanggang/view_edit/'+id
    }
    ...
    function hapus(){
      ...
      $.ajax({
        url: '<?php echo base_url('master/gelanggang/hapus') ?>',
        method: 'GET',
        data: {id},
        dataType: 'json',
        success: function (res) {
