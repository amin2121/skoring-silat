...
<div class="app-heading-container app-heading-bordered bottom">
    <ul class="breadcrumb">
        <li class="active">Jadwal Seni Tunggal</li>
    </ul>
</div>
<!-- END PAGE HEADING -->
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Data Jadwal Seni Tunggal</h3>
        </div>
        <div class="panel-body">
          <div>
              <ul class="nav nav-pills nav-pills">
                  <li class="active"><a href="#jadwal-pertandingan-sekarang" data-toggle="tab">Jadwal Seni Tunggal Sekarang</a></li>
                  <li><a href="#jadwal-pertandingan-selesai" data-toggle="tab">Jadwal Seni Tunggal Selesai</a></li>
              </ul>
...
<script>
    ...
    function get_data() {
        ...
        $.ajax({
            url: '<?= base_url('seni_tunggal/jadwal_seni_tunggal/get_data') ?>',
            method: 'GET',
    ...
    function get_data_tanding_selesai() {
        ...
        $.ajax({
            url: '<?= base_url('seni_tunggal/jadwal_seni_tunggal/get_data_tanding_selesai') ?>',
            method: 'GET',
            data: {search, gelanggang},
            dataType: 'json',
