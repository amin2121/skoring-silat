...
<html>
  <head>
    <meta charset="utf-8">
    <title>Laporan Perolehan Nilai</title>
  ...
  <body class="body">
    <center><h2>Laporan Perolehan Nilai</h2></center>
    ...
    <table style="width: 100%;" class="grid">
      <thead>
        <tr>
          ...
          <th style="text-align: center;">No Partai</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style="text-align:center;"><?php echo $res['no_partai']; ?></td>
